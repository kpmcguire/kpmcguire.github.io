        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="applyBtn btn btn-sm btn-primary " disabled="disabled"></button>&nbsp;' +
                    '<button class="cancelBtn btn btn-sm"></button>' +
                  '</div>' +
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fa fa-arrow-left icon-arrow-left flaticon solid left-arrow-1"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="fa fa-arrow-right icon-arrow-right flaticon solid right-arrow-1"></i></th>';
            } else {
                html += '<th></th>';
            }
