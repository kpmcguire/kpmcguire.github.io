(function($) {
    ...
    Selectpicker.prototype = {
        ...
        setSize:function() {
            ...
            var borderTopWidth = parseInt(menu.css('border-top-width'), 10);
            var borderBottomWidth = parseInt(menu.css('border-bottom-width'), 10);
            var menuPadding = paddingTop + paddingBottom + borderTopWidth + borderBottomWidth;
...
//                menu.css({'max-height' : '325px', 'overflow-y' : 'auto'});
