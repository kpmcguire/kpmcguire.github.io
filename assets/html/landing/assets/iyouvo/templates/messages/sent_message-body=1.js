(function() {
  ...
  this.HandlebarsTemplates["iyouvo/templates/messages/sent_message"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, helper, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "<div class=\"received_message read\" id=\"received_message_";
  ...
  buffer += escapeExpression(stack1)
    + "\n  </div>\n  <div class=\"message_date_time pull-left\">\n    ";
  ...
  return this.HandlebarsTemplates["iyouvo/templates/messages/sent_message"];
}).call(this);
